"""
  ...
  * History:
    1. _batch_size=64, _embed_size=250, _hidden_dim=30, _num_layers=3 最高达到0.839
    3. _batch_size=64, _embed_size=120, _hidden_dim=20, _num_layers=3 最高达到0.837
    4. _batch_size=64, _embed_size=300, _hidden_dim=100, _num_layers=3 最高达到0.835
...
if __name__ == '__main__':
    ...
    # model
    model = BiLSTMModel3(vocab_size=len(processer.vocab), embed_size=_embed_dim, hidden_size=_hidden_dim,
