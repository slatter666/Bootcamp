"""
  * FileName: TextClassifierSVM3
  * Author:   Slatter
  * Date:     2022/7/23 13:25
  * Description: 使用字级别的特征进行拟合
  * History:
    1、kernel = 'linear' C=0.35  val_F1 = 0.885  test_F1 = 0.855
    2、kernel = 'rbf' C=0.47 val_F1 = 0.89  test_F1 = 0.85
    3、kernel = 'sigmoid' C=0.35 val_F1 = 0.88  test_F1 = 0.853
"""
...
class TextClassifierSVM3(TextClassifier):
    def __init__(self, train_file_path, val_file_path, test_file_path) -> None:
        ...
        # svm模型
        self.svm_model = SVC(kernel='linear', C=0.35)
...
if __name__ == '__main__':
    ...
    classifier = TextClassifierSVM3(train_data_path, val_data_path, test_data_path)
    classifier.run()
