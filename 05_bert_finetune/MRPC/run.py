...
def predict(ck_path, save_path):
    ...
    indexes = [i for i in range(len(res))]  # 这里并没有给index，我们需要自己造
...
if __name__ == '__main__':
    # train()
    ck_path = './checkpoints/3e-05/epoch=3-val_f1=0.90.ckpt'
    save_path = '/data2/daijincheng/bert_finetune/submission/MRPC.tsv'
