...
if __name__ == '__main__':
    # train()
    ck_path = './checkpoints/2e-05/epoch=2-val_acc=0.91.ckpt'
    save_path = '/data2/daijincheng/bert_finetune/submission/QNLI.tsv'
