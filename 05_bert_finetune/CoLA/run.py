...
def train():
    ...
    model = ColaBert(num_class, lr)

    # training
    checkpoint_path = os.path.join(save_dir, 'cola', str(lr))
...
if __name__ == '__main__':
    # train()
    ck_path = '/data2/daijincheng/bert_finetune/CoLA/checkpoints/cola/2e-05/epoch=3-val_corr=0.62.ckpt'
    save_path = '/data2/daijincheng/bert_finetune/submission/CoLA.tsv'
