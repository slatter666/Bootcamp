...
def train():
    train_path = '/data2/daijincheng/datasets/GLUE/QQP/train.tsv'
    dev_path = '/data2/daijincheng/datasets/GLUE/QQP/dev.tsv'

    train_dataset = QQPDataset.load_dataset('train', train_path)
    dev_dataset = QQPDataset.load_dataset('dev', dev_path)
...
def predict(ck_path, save_path):
    test_path = '/data2/daijincheng/datasets/GLUE/QQP/test.tsv'
    test_dataset = QQPDataset.load_dataset('test', test_path)
...
if __name__ == '__main__':
    # train()
    ck_path = './checkpoints/2e-05/epoch=3-val_f1=0.88.ckpt'
    save_path = '/data2/daijincheng/bert_finetune/submission/QQP.tsv'
